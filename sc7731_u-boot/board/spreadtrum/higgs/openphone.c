...
static void board_misc_init(void)
{
	u32 reg_val;
	/*init vibrator voltage level*/
	reg_val = ANA_REG_GET(ANA_REG_GLB_BA_CTRL2);
	reg_val &= ~0xff;
	reg_val |= (3300-1200)/10;
	ANA_REG_SET(ANA_REG_GLB_BA_CTRL2, reg_val);
}
