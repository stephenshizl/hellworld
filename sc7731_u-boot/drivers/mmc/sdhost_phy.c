...
PUBLIC SDHOST_HANDLE SDHOST_Register (SDHOST_SLOT_NO slot_NO,SDIO_CALLBACK fun)
{
    ...
    // select slot 0
#if defined (CONFIG_SC8825) || defined(CONFIG_SPX15)||defined(CONFIG_SPX30G) /*CONFIG_SPX15 must be before CONFIG_SC8830*/
...
#elif defined(CONFIG_SC8830)
#ifdef CONFIG_SPX15
#define REG_PIN_EMMC_CLK     REG_PIN_NFREN
#define REG_PIN_EMMC_CMD     REG_PIN_NFRB
#define REG_PIN_EMMC_D0      REG_PIN_NFWPN
#define REG_PIN_EMMC_D1      REG_PIN_NFD11
#define REG_PIN_EMMC_D2      REG_PIN_NFD14
#define REG_PIN_EMMC_D3      REG_PIN_NFD7
#define REG_PIN_EMMC_D4      REG_PIN_NFD5
#define REG_PIN_EMMC_D5      REG_PIN_NFD4
#define REG_PIN_EMMC_D6      REG_PIN_NFCLE
#define REG_PIN_EMMC_D7      REG_PIN_NFALE
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_CLK)= 0x210;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_CMD)= 0x1198;
			REG32(CTL_PIN_BASE+REG_PIN_NFD10)   = 0x198;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D0) = 0x198;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D1) = 0x198;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D2) = 0x198;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D3) = 0x198;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D4) = 0x198;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D5) = 0x198;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D6) = 0x198;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D7) = 0x198;
#elif defined(CONFIG_SPX30G)
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_CLK)= 0x80000;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_CMD)= 0x80080;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D0) = 0x80080;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D1) = 0x80080;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D2) = 0x80080;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D3) = 0x80080;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D4) = 0x80080;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D5) = 0x80080;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D6) = 0x80080;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D7) = 0x80080;
#else
