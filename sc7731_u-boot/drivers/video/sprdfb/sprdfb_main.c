...
void set_backlight(uint32_t value)
{
	...
	defined(CONFIG_SP7731GEA) || defined(CONFIG_SP7731GEA_LM) || defined(CONFIG_SP7731GEA_FWVGA) || defined(CONFIG_SP7731GEAOPENPHONE) || \
	...
	defined(CONFIG_SC9620REFERPHONE))
...
#if (defined(CONFIG_TSHARKWSAMSUNG) || defined(CONFIG_CORE3))
...
#elif defined(CONFIG_KANAS_W) || defined(CONFIG_KANAS_TD) || defined(CONFIG_PIKEAYOUNG2DTV)
