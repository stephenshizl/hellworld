...
#define ANA_REG_GLB_LDO_DCDC_PD         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0010)
#define ANA_REG_GLB_LDO_PD_CTRL         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0014)
#define ANA_REG_GLB_LDO_V_CTRL0         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0018)
#define ANA_REG_GLB_LDO_V_CTRL1         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x001C)
#define ANA_REG_GLB_LDO_V_CTRL2         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0020)
#define ANA_REG_GLB_LDO_V_CTRL3         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0024)
#define ANA_REG_GLB_LDO_V_CTRL4         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0028)
#define ANA_REG_GLB_LDO_V_CTRL5         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x002C)
#define ANA_REG_GLB_LDO_V_CTRL6         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0030)
#define ANA_REG_GLB_LDO_V_CTRL7         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0034)
#define ANA_REG_GLB_LDO_V_CTRL8         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0038)
#define ANA_REG_GLB_LDO_V_CTRL9         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x003C)
#define ANA_REG_GLB_LDO_V_CTRL10        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0040)
#define ANA_REG_GLB_LDO_V_CTRL11        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0044)
#define ANA_REG_GLB_LDO_LP_CTRL         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0048)
...
#define ANA_REG_GLB_DCDC_CTRL7          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0068)
#define ANA_REG_GLB_DCDC_CTRL8          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x006C)
#define ANA_REG_GLB_DCDC_CTRL9          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0070)
#define ANA_REG_GLB_DCDC_CTRL10         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0074)
#define ANA_REG_GLB_DCDC_CTRL11         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0078)
#define ANA_REG_GLB_DCDC_CTRL12         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x007C)
#define ANA_REG_GLB_DCDC_CTRL13         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0080)
#define ANA_REG_GLB_DCDC_CTRL14         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0084)
#define ANA_REG_GLB_DCDC_CTRL15         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0088)
#define ANA_REG_GLB_SLP_WAIT_DCDCARM    SCI_ADDR(ANA_REGS_GLB_PHYS, 0x008C)
#define ANA_REG_GLB_PWR_SLP_CTRL0       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0090)
#define ANA_REG_GLB_PWR_SLP_CTRL1       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0094)
#define ANA_REG_GLB_PWR_SLP_CTRL2       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0098)
#define ANA_REG_GLB_PWR_SLP_CTRL3       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x009C)
#define ANA_REG_GLB_PWR_SLP_CTRL4       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00A0)
#define ANA_REG_GLB_AUD_SLP_CTRL        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00A4)
#define ANA_REG_GLB_DCDC_SLP_CTRL0      SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00A8)
#define ANA_REG_GLB_DCDC_SLP_CTRL1      SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00AC)
#define ANA_REG_GLB_DCDC_SLP_CTRL2      SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00B0)
#define ANA_REG_GLB_DCDC_SLP_CTRL3      SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00B4)
#define ANA_REG_GLB_DCDC_SLP_CTRL4      SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00B8)
#define ANA_REG_GLB_DCDC_SLP_CTRL5      SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00BC)
#define ANA_REG_GLB_PWR_SEL             SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00C0)
#define ANA_REG_GLB_PWR_XTL_EN0         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00C4)
#define ANA_REG_GLB_PWR_XTL_EN1         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00C8)
#define ANA_REG_GLB_PWR_XTL_EN2         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00CC)
#define ANA_REG_GLB_PWR_XTL_EN3         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00D0)
#define ANA_REG_GLB_32KLESS_CTRL0       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00D4)
#define ANA_REG_GLB_32KLESS_CTRL1       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00D8)
#define ANA_REG_GLB_32KLESS_CTRL2       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00DC)
#define ANA_REG_GLB_32KLESS_CTRL3       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00E0)
#define ANA_REG_GLB_AUXAD_CTL           SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00E4)
#define ANA_REG_GLB_XTL_WAIT_CTRL       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00E8)
#define ANA_REG_GLB_RGB_CTRL            SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00EC)
#define ANA_REG_GLB_WHTLED_CTRL         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00F0)
#define ANA_REG_GLB_KPLED_CTRL          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00F4)
#define ANA_REG_GLB_VIBR_CTRL0          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00F8)
#define ANA_REG_GLB_AUDIO_CTRL0         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x00FC)
#define ANA_REG_GLB_AUDIO_CTRL1         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0100)
#define ANA_REG_GLB_CHGR_CTRL0          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0104)
#define ANA_REG_GLB_CHGR_CTRL1          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0108)
#define ANA_REG_GLB_CHGR_CTRL2          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x010C)
#define ANA_REG_GLB_CHGR_DET_FGU_CTRL   SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0110)
#define ANA_REG_GLB_CHGR_STATUS         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0114)
#define ANA_REG_GLB_MIXED_CTRL0         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0118)
#define ANA_REG_GLB_MIXED_CTRL1         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x011C)
#define ANA_REG_GLB_SWRST_CTRL          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0120)
#define ANA_REG_GLB_POR_RST_MONITOR     SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0124)
#define ANA_REG_GLB_WDG_RST_MONITOR     SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0128)
#define ANA_REG_GLB_POR_PIN_RST_MONITOR SCI_ADDR(ANA_REGS_GLB_PHYS, 0x012C)
#define ANA_REG_GLB_POR_SRC_FLAG        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0130)
#define ANA_REG_GLB_POR_7S_CTRL         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0134)
#define ANA_REG_GLB_HWRST_RTC           SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0138)
#define ANA_REG_GLB_CHIP_ID_LOW         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x013C)
#define ANA_REG_GLB_CHIP_ID_HIGH        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0140)
#define ANA_REG_GLB_ARM_MF_REG          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0144)
#define ANA_REG_GLB_ARCH_EN             SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0148)
#define ANA_REG_GLB_MCU_WR_PROT_VALUE   SCI_ADDR(ANA_REGS_GLB_PHYS, 0x014C)
#define ANA_REG_GLB_PWR_WR_PROT_VALUE   SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0150)
#define ANA_REG_GLB_SMPL_CTRL0          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0154)
#define ANA_REG_GLB_SMPL_CTRL1          SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0158)
#define ANA_REG_GLB_RTC_RST0            SCI_ADDR(ANA_REGS_GLB_PHYS, 0x015C)
#define ANA_REG_GLB_RTC_RST1            SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0160)
#define ANA_REG_GLB_RTC_RST2            SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0164)
#define ANA_REG_GLB_LDO_SHPT_PD1        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0188)
#define ANA_REG_GLB_LDO_SHPT_PD2        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x018C)
#define ANA_REG_GLB_BATDET_CUR_CTRL     SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0190)
#define ANA_REG_GLB_RTC_CLK_STOP        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0194)
#define ANA_REG_GLB_VBAT_DROP_CNT       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0198)
#define ANA_REG_GLB_DCDC_DISCHRG        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x019C)
#define ANA_REG_GLB_DCDC_CORE_ADI       SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0200)
#define ANA_REG_GLB_DCDC_ARM_ADI        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0204)
#define ANA_REG_GLB_DCDC_MEM_ADI        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0208)
#define ANA_REG_GLB_DCDC_GEN_ADI        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x020C)
#define ANA_REG_GLB_DCDC_WPA_ADI        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0210)
#define ANA_REG_GLB_DCDC_WPA_DCM_ADI    SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0214)
#define ANA_REG_GLB_DCDC_CON_ADI        SCI_ADDR(ANA_REGS_GLB_PHYS, 0x0218)
#define ANA_REG_GLB_DCDC_RF_ADI         SCI_ADDR(ANA_REGS_GLB_PHYS, 0x021C)
