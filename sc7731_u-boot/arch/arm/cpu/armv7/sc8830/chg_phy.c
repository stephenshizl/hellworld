...
{
#if defined(CONFIG_SPX15) || defined(CONFIG_ADIE_SC2723S) || defined(CONFIG_ADIE_SC2723)
...
void CHG_SetChgCur(uint32_t chg_current)
{
	uint32_t temp;
