...
#define CP1_CODE_COPY_ADR 0x50001800
#define CP2_CODE_COPY_ADR 0x50003000
#define CP_SOFT_RST_ADR   0x402B00A8
#define PD_CP0_SYS_CFG_ADR  0x402B003C
#define PD_CP1_SYS_CFG_ADR  0x402B0050
#define PD_CP2_SYS_CFG_ADR  0x402B0060
#define PD_CP2_ARM9_CFG_ADR 0x402B0054
#define PWR_STATUS1_DBG_ADR   0x402B00B8
#define PWR_STATUS2_DBG_ADR   0x402B00BC
#define PWR_STATUS3_DBG_ADR   0x402B00C0

#define CONFIG_AUTODLOADER
#define CONFIG_SIMLOCK_ENABLE
...
#define TDMODEM_SIZE		(0x600000)
#define TDDSP_SIZE		(0x2E0000)
#define WCNMODEM_SIZE		(0x800000)
...
//#elif defined(CONFIG_RAMxxxM)
//#define SPRD_SYSDUMP_MAGIC      ((PHYS_OFFSET_ADDR & (~(SZ_xxxM - 1))) + SZ_xxxM - SZ_1M) //xxx maybe 1024 etc
#else
#error "CONFIG_RAMxxxM macro must be defined"
#endif

#define CALIBRATE_ENUM_MS 5000
...
#define LOW_BAT_VOL_CHG        3200    //3.3V charger connect
...
#define WCN_CP_SDRAM_SIZE		0x281000//0x400000	/*4M*/
...
#define modem_cp0_enable 0
#define modem_cp1_enable 1
