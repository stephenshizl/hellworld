...
#define TDMODEM_SIZE		(0xA00000)
#define TDDSP_SIZE		(0x3E0400) /* 3968K */
#define WCNMODEM_SIZE		(0xA00000)
...
#define WCN_CP_SDRAM_SIZE		0x1000000	/*16M*/
...
#define USB_PHY_TUNE_VALUE 0x44077e33
