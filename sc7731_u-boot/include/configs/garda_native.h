...
#define CONFIG_BOOTARGS "mem=256M console=ttyS1,115200n8 androidboot.console=ttyS1 init=/init " MTDPARTS_DEFAULT
#endif
...
#define CONFIG_FB_LCD_NT35510_MIPI
#define CONFIG_FB_LCD_NT35512_MIPI
