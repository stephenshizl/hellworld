...
#if(defined(CONFIG_LEDS_SPRD_BLTC_RGB) || defined(CONFIG_LEDS_SPRD_BLTC_RGB_MODULE))
...
#if(defined(CONFIG_LEDS_SPRD_BLTC_RGB) || defined(CONFIG_LEDS_SPRD_BLTC_RGB_MODULE))
static struct sprd_leds_bltc_rgb_platform_data sprd_leds_bltc_rgb_pdata= {
	.sprd_base_addr = 0Xf53f8000;
};
#endif

#if(defined(CONFIG_LEDS_SPRD_BLTC_RGB) || defined(CONFIG_LEDS_SPRD_BLTC_RGB_MODULE))
struct platform_device sprd_leds_bltc_rgb_device = {
...
#if(defined(CONFIG_LEDS_SPRD_BLTC_RGB) || defined(CONFIG_LEDS_SPRD_BLTC_RGB_MODULE))
	 { .compatible = "sprd,sprd-leds-bltc-rgb",  .name = "sprd-leds-bltc-rgb" },
#endif
	 {}
};
#endif
...
#if(defined(CONFIG_LEDS_SPRD_BLTC_RGB) || defined(CONFIG_LEDS_SPRD_BLTC_RGB_MODULE))
	platform_device_add_data(&sprd_leds_bltc_rgb_device,(const void*)&sprd_leds_bltc_rgb_pdata,sizeof(sprd_leds_bltc_rgb_pdata));
#endif
